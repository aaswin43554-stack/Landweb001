...
const FALLBACK_TRANSLATIONS: Record<string, TranslationEntry> = {
  ...
  'login.title': {
    lao_text: 'ລະບົບຂໍ້ມູນທີ່ດິນ GIZ',
    english_text: 'GIZ Land Info System',
    hmong_text: 'GIZ Ntaub Ntawv Av',
    khmu_text: 'GIZ Land System',
  },
  'login.subtitle': {
    lao_text: 'ເວັບໄຊເຂົ້າสู่ລະບົບຢ່າງເປັນທາງການ',
    english_text: 'Official Secure Access Portal',
    hmong_text: 'Qhov Chaw Sau Npe Raug Tswj',
    khmu_text: 'Official Access Portal',
  },
  'login.tab_passkey': {
    lao_text: '🎙️ ລະຫັດຜ່ານໄບໂອເມຕຣິກ',
    english_text: '🎙️ Biometric Passkey',
    hmong_text: '🎙️ Biometric Passkey',
    khmu_text: '🎙️ Biometric Passkey',
  },
  'login.tab_qr': {
    lao_text: '🪪 ເຂົ້າสู่ລະບົບດ້ວຍບັດ QR',
    english_text: '🪪 QR Card Login',
    hmong_text: '🪪 QR Card Login',
    khmu_text: '🪪 QR Card Login',
  },
  'login.select_profile_hint': {
    lao_text: 'ເລືອກໂປຣໄຟລ໌ຂອງທ່ານ ແລະ ເລືອກວິທີເຂົ້າสู่ລະບົບ',
    english_text: 'Select your profile and choose how you want to log in.',
    hmong_text: 'Xaiv koj li profile thiab nrhiav kev sau npe',
    khmu_text: 'Select profile & login method',
  },
  'login.select_account_label': {
    lao_text: 'ເລືອກບັນຊີໄບໂອເມຕຣິກ',
    english_text: 'Select Biometric Account',
    hmong_text: 'Xaiv Account',
    khmu_text: 'Select Account',
  },
  'login.btn_fingerprint': {
    lao_text: 'ເຂົ້າสู่ລະບົບດ້ວຍລາຍນິ້ວມື / Passkey',
    english_text: 'Log In with Fingerprint / Passkey',
    hmong_text: 'Sau Npe Nrog Fingerprint',
    khmu_text: 'Login with Fingerprint',
  },
  'login.btn_pin': {
    lao_text: 'ເຂົ້າสู่ລະບົບດ້ວຍລະຫັດ PIN 4 ຫຼັກ',
    english_text: 'Log In with 4-Digit Backup PIN',
    hmong_text: 'Sau Npe Nrog 4-Digit PIN',
    khmu_text: 'Login with 4-Digit PIN',
  },
  'login.register_link': {
    lao_text: 'ລົງທະບຽນອຸປະກອນໄບໂອເມຕຣິກໃໝ່ ➔',
    english_text: 'Register new biometric device credentials ➔',
    hmong_text: 'Sau npe biometric tshiab ➔',
    khmu_text: 'Register new biometrics ➔',
  },
  'login.onboard_title': {
    lao_text: 'ລົງທະບຽນ ໄບໂອເມຕຣິກ / Passkey',
    english_text: 'Onboard Biometrics / Passkey',
    hmong_text: 'Sau Npe Biometrics',
    khmu_text: 'Onboard Biometrics',
  },
  'login.qr_hint': {
    lao_text: 'ສະແກນລະຫັດ QR ໃນບັດປະຈຳຕົວປະຊາຊົນ GIZ ດ້ວຍກ້ອງถ่ายຮູບ, ຫຼື ພິມລະຫັດຢູ່ດ້ານລຸ່ມ',
    english_text: 'Scan your physical GIZ Citizen Identity Card QR code using your device camera, or input it manually below.',
    hmong_text: 'Luam QR code hauv koj li card lossis sau hauv qab no.',
    khmu_text: 'Scan QR card or type code below.',
  },
  'login.open_camera': {
    lao_text: 'ເປີດກ້ອງສະແກນ',
    english_text: 'Open Scanner Camera',
    hmong_text: 'Qhib Camera',
    khmu_text: 'Open Camera',
  },
  'login.or_type_id': {
    lao_text: 'ຫຼື ພິມລະຫັດປະຈຳຕົວ',
    english_text: 'or type credentials ID',
    hmong_text: 'lossis sau ID',
    khmu_text: 'or type ID',
  },
  'login.submit': {
    lao_text: 'ສົ່ງຂໍ້ມູນ',
    english_text: 'Submit',
  ...
  'login.verify_pin_title': {
    lao_text: 'ໃສ່ລະຫັດ PIN 4 ຫຼັກ',
    english_text: 'Enter 4-Digit Backup PIN',
    hmong_text: 'Sau 4-Digit Backup PIN',
    khmu_text: 'Enter 4-Digit PIN',
  },
  'login.verify_pin_hint': {
    lao_text: 'ໃສ່ລະຫັດ PIN 4 ຫຼັກຂອງທ່ານ (ຄ່າເລີ່ມຕົ້ນ: 1234 / 1010).',
    english_text: 'Enter your 4-digit backup PIN (default: 1234 / 1010).',
    hmong_text: 'Sau 4-digit backup PIN (default: 1234 / 1010).',
    khmu_text: 'Enter 4-digit PIN (default: 1234 / 1010).',
  },
  'login.switch_to_pin': {
    lao_text: '🔢 ໃຊ້ລະຫັດ PIN 4 ຫຼັກແທນ ➔',
    english_text: '🔢 Use 4-Digit Backup PIN Instead ➔',
    hmong_text: '🔢 Ua Nrog 4-Digit PIN ➔',
    khmu_text: '🔢 Use 4-Digit PIN Instead ➔',
  },
  'login.switch_to_fingerprint': {
    lao_text: '🎙️ ໃຊ້ການສະແກນລາຍນິ້ວມືແທນ ➔',
    english_text: '🎙️ Use Fingerprint Scan Instead ➔',
    hmong_text: '🎙️ Ua Nrog Fingerprint ➔',
    khmu_text: '🎙️ Use Fingerprint Instead ➔',
  },
  'login.close_modal': {
    lao_text: 'ປິດໜ້າຕ່າງ',
    english_text: 'Close Modal',
    hmong_text: 'Kaw Modal',
    khmu_text: 'Close Modal',
  },
  'zone_explain.forest': {
